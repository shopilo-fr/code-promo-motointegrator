#!/usr/bin/env python3
"""
Recuperation des codes promo Motointegrator depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/motointegrator.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/motointegrator.fr"
STORE_NAME = "Motointegrator"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Motointegrator depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-motointegrator)"
    }
    try:
